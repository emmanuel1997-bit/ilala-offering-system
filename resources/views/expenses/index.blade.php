...
<div class="container py-4">
    <div class="card shadow-sm border-0 rounded-3">
        <div class="card-header bg-white d-flex justify-content-between align-items-center">
            <h4 class="fw-semibold text-dark mb-0">Expense Records</h4>
            <div class="d-flex gap-2">
                <a href="" class="btn btn-outline-success">
                    <i class="fas fa-file-excel me-1"></i> Export Excel
                </a>
                <button class="btn text-white" style="background-color:#064e3b;" data-bs-toggle="modal" data-bs-target="#addExpenseModal">
        ...
        <div class="card-body">
            ...
            <form method="GET" class="row g-2 mb-3 align-items-end">
                <div class="col-md-3">
                    ...
                    <input type="text" name="search" value="{{ request('search') }}" class="form-control" placeholder="Search by item or description...">
                </div>
                ...
                <table class="table table-bordered table-striped align-middle">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <form action="{{ route('expenses.destroy', $expense->id) }}" method="POST" class="d-inline" onsubmit="return confirm('Delete this record?')">
                                    @csrf
                                    @method('DELETE')
