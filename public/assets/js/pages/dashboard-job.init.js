...
newApplicationColors &&
    ((options = {
        series: [{ name: "New Application", data: [36, 48, 10, 74, 35, 50, 70, 73] }],
        chart: { width: 130, height: 46, type: "area", sparkline: { enabled: !0 }, toolbar: { show: !1 } },
        dataLabels: { enabled: !1 },
        stroke: { curve: "smooth", width: 1.5 },
        fill: { type: "gradient", gradient: { shadeIntensity: 1, inverseColors: !1, opacityFrom: 0.45, opacityTo: 0.05, stops: [50, 100, 100, 100] } },
...
totalApprovedColors &&
    ...
    (chart = new ApexCharts(document.querySelector("#total_approved_charts"), options)).render()),
    (totalApprovedColors = getChartColorsArray("total_rejected_charts")) &&
        ((options = {
            series: [{ name: "Total Rejected", data: [32, 22, 7, 55, 20, 45, 36, 20] }],
            chart: { width: 130, height: 46, type: "area", sparkline: { enabled: !0 }, toolbar: { show: !1 } },
            dataLabels: { enabled: !1 },
            stroke: { curve: "smooth", width: 1.5 },
            fill: { type: "gradient", gradient: { shadeIntensity: 1, inverseColors: !1, opacityFrom: 0.45, opacityTo: 0.05, stops: [50, 100, 100, 100] } },
...
statisticsApplicationColors &&
    ((options = {
        series: [
            { name: "Companay", type: "column", data: [30, 48, 28, 74, 39, 87, 54, 36, 50, 87, 84] },
            { name: "New Jobs", type: "column", data: [20, 50, 42, 10, 24, 28, 60, 35, 47, 64, 78] },
            { name: "Total Jobs", type: "area", data: [44, 55, 41, 67, 22, 43, 21, 41, 56, 27, 43] },
            { name: "Job View", type: "line", data: [30, 25, 36, 30, 45, 35, 64, 52, 59, 36, 39] },
        ],
        chart: { height: 350, type: "line", stacked: !1, toolbar: { show: !1 } },
        legend: { show: !0, offsetY: 10 },
        stroke: { width: [0, 0, 2, 2], curve: "smooth" },
        plotOptions: { bar: { columnWidth: "30%" } },
        fill: { opacity: [1, 1, 0.1, 1], gradient: { inverseColors: !1, shade: "light", type: "vertical", opacityFrom: 0.85, opacityTo: 0.55, stops: [0, 100, 100, 100] } },
...
var options,
    chart,
    ApplicationReveicedTimeColors = getChartColorsArray("application-received-time");
ApplicationReveicedTimeColors &&
    ((options = {
        series: [{ name: "Received Application", data: [34, 44, 54, 21, 12, 43, 33, 80, 66] }],
